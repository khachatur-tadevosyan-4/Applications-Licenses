...
Your IP address and device identifiers such as your Advertising ID (Google Advertising Identity), Device ID numbers (for more see here Advertising IDs and Device IDs)
